...
def create_directories() -> None:
    if not os.path.exists("uploads"):
        os.makedirs("uploads/preprocessed-image-fire")
        os.makedirs("uploads/processed-image-pose")

    if not os.path.exists("uploads/preprocessed-image-fire"):
        os.makedirs("uploads/preprocessed-image-fire")
...
def pose_detection() -> None:
    ...
    return jsonify(
        {"message": "Landmark detection successful.", "processed_image": output_image}
    )
