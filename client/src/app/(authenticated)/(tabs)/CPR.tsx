...
export default function App() {
  ...
  const { data, errorMsg, loading, postData } = usePost("/api/v1/videofeed");

  const audioFiles: { [key: string]: any } = {
    'hizimagenai.mp3': require("../../../assets/audio/hizimagenai.mp3"),
  ...
  return (
    <SafeAreaView style={styles.saveAreaContainer}>
      ...
      <View style={styles.audioButtonsContainer}>
        ...
        <Button title="Play Straighten Arms Sound" onPress={() => playSound('straighten.mp3')} />
